...
def update_categories():
    ...
    try:
        ...
        logging.info(f"Categories saved to {categories_file}")
    except Exception as e:
        logging.error("Error saving categories to JSON file:")
        traceback.print_exc()
...
def scrape_categories() -> dict:
    ...
    for element in category_elements:
        try:
            ...
            logging.error(f"Error processing element {element.text}:")
            traceback.print_exc()
